...
function ReanderPosts(setter) {
    ...
    return (
        <ul className='post_list'>
            {post.length ?
            post.map(p => {
            let imgSrc = p.user_avatar ? 'https://blog-site-team-server.herokuapp.com/avatar/' + p.user_avatar : avatar
            let styleFile = {
            ...
            <li className='post_item' key={p.post_uid}>
                ...
                <img className='post_img' src={'https://blog-site-team-server.herokuapp.com/post/' + p.post_img} alt="img" />
